...
Below is an **updated README adjusted to your final version** of the project.
I kept the **image unchanged** and updated the text to include **Dynamic Programming, Backtracking, Merge Sort (Divide & Conquer), and the improved greedy solver**.
